...
class Player {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            if(!thor.attack(monsters)){ //if there's a close monster attack him
